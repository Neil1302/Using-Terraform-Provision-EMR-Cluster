...
assume_role_poicy = data.aws_iam_policy_document.emr_assume_role.json
}
...
assume_role_poicy = data.aws_iam_policy_document.emr_autoscaling_role_policy.json
}
...
assume_role_poicy = data.aws_iam_policy_document.ec2_assume_role.json
}
